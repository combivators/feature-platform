 ...
 *
 * 焦点渐变循环切换：Slider.gradual({参数:值,参数:值,...}
 * 焦点滚动循环切换：Slider.scroll({参数:值,参数:值,...}
 * 连续无缝循环滚动：Slider.rolling({参数:值,参数:值,...})
 */
var Slider = {
    fspeed: 1E3,
    aspeed: 5E3,
